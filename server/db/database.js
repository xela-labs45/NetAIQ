...
if (legacyInterval) {
    ...
    db.prepare("INSERT OR IGNORE INTO settings (key, value) VALUES ('segment_scan_interval', ?)").run(legacySeconds.toString());
    db.prepare("INSERT OR IGNORE INTO settings (key, value) VALUES ('critical_ping_interval', '120')").run();
